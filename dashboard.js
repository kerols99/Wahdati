...
async function loadSmartDash(ym) {
  try {
    ...
    // بناء historicRentMap بعد اكتمال allInMonth — نفس منطق التقرير بالظبط
...
function initDashboard() {
  ...
  ['rpm','rcoll-month','rem','rdep-month','o-month','rfin-month','rrefund-month','rdeduct-month','rvacant-month','raccrual-month','rdisc-month'].forEach(function(id){
